...
public class ControlPersonajeP1 : MonoBehaviour
{
    private Rigidbody2D rb2D;
    private Animator animator;
    private SistemaCombate ayudaDiosito;
    ...
    void Start()
    {
        ...
        ayudaDiosito = GetComponent<SistemaCombate>();
        ayudaDiosito.enabled = true; 
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.LeftShift) && tiempoUltimoDash>1.0f){
            StartCoroutine(Dash());
            tiempoUltimoDash=0;
        }
